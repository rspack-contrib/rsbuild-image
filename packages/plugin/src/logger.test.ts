...
describe('logger', () => {
  ...
  describe('isDebug', () => {
    ...
    it('should return true when DEBUG includes rsbuild:image', () => {
      process.env.DEBUG = 'rsbuild:image';
      expect(isDebug()).toBe(true);
    });

    it('should return true when DEBUG includes RSBUILD:IMAGE (uppercase)', () => {
      process.env.DEBUG = 'RSBUILD:IMAGE';
      expect(isDebug()).toBe(true);
    });
    ...
    it('should work correctly when DEBUG contains multiple values', () => {
      process.env.DEBUG = 'other:debug,rsbuild:image,something:else';
      expect(isDebug()).toBe(true);
    });
